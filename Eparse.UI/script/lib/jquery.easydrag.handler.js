...
(function($){
	...
	$.updatePosition = function (e) {
	    ...
	    var newElemTop = ((lastElemTop + spanY) > (document.documentElement.clientHeight - elemHeight)) ?
	        (document.documentElement.clientHeight - elemHeight) : (lastElemTop + spanY);
	    ...
	    if (newElemTop < 30) newElemTop = 30;
	...
	$.fn.easydrag = function(allowBubbling){
		...
		return this.each(function(){
			...
			$(this).mousedown(function(e){
				...
				// set z-index
				$(this).css("z-index", parseInt( new Date().getTime()/1000000 ));
